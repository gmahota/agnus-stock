...
const Question = ({question, answer, children, badges}) => {
  ...
  return (
    <div className="flex items-center justify-start py-3 px-3 border-t first:border-t-0 border-gray-100">
      <div className="flex flex-col w-full">
        <div className="flex flex-row items-center justify-between">
          <button
            onClick={() => setHidden(!hidden)}
            className="bg-transparent text-gray-900 flex flex-row items-center justify-between w-full">
